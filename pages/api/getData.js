...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res
      .status(500)
      .json({ error: 'Service account credentials not set properly' });
  }
  ...
  // Replace with your actual spreadsheet ID (this one is correct based on your URL)
  ...
  try {
    ...
    // Find the row where the DOT column matches the query parameter
